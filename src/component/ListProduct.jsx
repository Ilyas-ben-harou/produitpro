...
const ListProduct = ({ data }) => {
    ...
    const displayPanier = () => {
        ...
        return (
            panier.map((item, index) => {
                return (
                    <div key={index} className="max-w-sm mx-auto my-2 bg-white shadow-md rounded-lg overflow-hidden p-4">
    ...
    if (!isClicked) {
        return (
            <div className="container-fluid bg-secondary " style={{ marginTop: '80px' }}>
                {displayNavBar()}
                <div>
                    <h1 className="text-3xl font-bold text-gray-800 ">List of Products:</h1>
                    <h2>Nombre des Produits : {panier.reduce((acc, item) => acc + item.qte, 0)}</h2>
                    <div className='flex justify-around items-start m-auto flex-wrap text-center'>
                        {displayPanier()}
                    </div>
    ...
    return (
        <div className="container-fluid bg-secondary " style={{ marginTop: '80px' }}>
            ...
            <div className='mt-3'>
                ...
                <div className='flex justify-between items-start m-auto flex-wrap text-center' >
